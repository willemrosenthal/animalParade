...
{
HX_STACK_PUSH("Stage::new","flash/display/Stage.hx",85);
{
	HX_STACK_LINE(87)
...
int Stage_obj::get_stageWidth( ){
	HX_STACK_PUSH("Stage::get_stageWidth","flash/display/Stage.hx",1231);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1231)
...
int Stage_obj::get_stageHeight( ){
	HX_STACK_PUSH("Stage::get_stageHeight","flash/display/Stage.hx",1224);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1224)
...
bool Stage_obj::set_stageFocusRect( bool value){
	HX_STACK_PUSH("Stage::set_stageFocusRect","flash/display/Stage.hx",1216);
	HX_STACK_THIS(this);
...
bool Stage_obj::get_stageFocusRect( ){
	HX_STACK_PUSH("Stage::get_stageFocusRect","flash/display/Stage.hx",1215);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1215)
...
::flash::display::Stage Stage_obj::get_stage( ){
	HX_STACK_PUSH("Stage::get_stage","flash/display/Stage.hx",1208);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1208)
...
::flash::display::StageScaleMode Stage_obj::set_scaleMode( ::flash::display::StageScaleMode value){
	HX_STACK_PUSH("Stage::set_scaleMode","flash/display/Stage.hx",1200);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(1202)
...
::flash::display::StageScaleMode Stage_obj::get_scaleMode( ){
	HX_STACK_PUSH("Stage::get_scaleMode","flash/display/Stage.hx",1192);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1194)
...
::flash::display::StageQuality Stage_obj::set_quality( ::flash::display::StageQuality value){
	HX_STACK_PUSH("Stage::set_quality","flash/display/Stage.hx",1184);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(1186)
...
::flash::display::StageQuality Stage_obj::get_quality( ){
	HX_STACK_PUSH("Stage::get_quality","flash/display/Stage.hx",1176);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1178)
...
bool Stage_obj::get_isOpenGL( ){
	HX_STACK_PUSH("Stage::get_isOpenGL","flash/display/Stage.hx",1169);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1169)
...
Float Stage_obj::set_frameRate( Float value){
	HX_STACK_PUSH("Stage::set_frameRate","flash/display/Stage.hx",1155);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(1161)
...
::flash::display::InteractiveObject Stage_obj::set_focus( ::flash::display::InteractiveObject value){
	HX_STACK_PUSH("Stage::set_focus","flash/display/Stage.hx",1138);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(1140)
	if (((value == null()))){
...
::flash::display::InteractiveObject Stage_obj::get_focus( ){
	HX_STACK_PUSH("Stage::get_focus","flash/display/Stage.hx",1129);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1131)
...
Float Stage_obj::get_dpiScale( ){
	HX_STACK_PUSH("Stage::get_dpiScale","flash/display/Stage.hx",1122);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1122)
...
::flash::display::StageDisplayState Stage_obj::set_displayState( ::flash::display::StageDisplayState value){
	HX_STACK_PUSH("Stage::set_displayState","flash/display/Stage.hx",1114);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(1116)
...
::flash::display::StageDisplayState Stage_obj::get_displayState( ){
	HX_STACK_PUSH("Stage::get_displayState","flash/display/Stage.hx",1106);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1108)
...
::flash::display::StageAlign Stage_obj::set_align( ::flash::display::StageAlign value){
	HX_STACK_PUSH("Stage::set_align","flash/display/Stage.hx",1098);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(1100)
...
::flash::display::StageAlign Stage_obj::get_align( ){
	HX_STACK_PUSH("Stage::get_align","flash/display/Stage.hx",1090);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1092)
...
Float Stage_obj::__updateNextWake( ){
	HX_STACK_PUSH("Stage::__updateNextWake","flash/display/Stage.hx",1060);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1062)
...
{
		HX_STACK_PUSH("Stage::__stopDrag","flash/display/Stage.hx",1052);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Stage::__startDrag","flash/display/Stage.hx",1019);
		HX_STACK_THIS(this);
		HX_STACK_ARG(sprite,"sprite");
...
{
		HX_STACK_PUSH("Stage::__setActive","flash/display/Stage.hx",969);
		HX_STACK_THIS(this);
		HX_STACK_ARG(value,"value");
		HX_STACK_LINE(969)
...
{
		HX_STACK_PUSH("Stage::__render","flash/display/Stage.hx",943);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Stage::__pollTimers","flash/display/Stage.hx",933);
		HX_STACK_THIS(this);
		HX_STACK_LINE(935)
...
{
		HX_STACK_PUSH("Stage::__onTouch","flash/display/Stage.hx",886);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Stage::__onSysWM","flash/display/Stage.hx",878);
		HX_STACK_THIS(this);
		HX_STACK_ARG(event,"event");
		HX_STACK_LINE(880)
...
{
		HX_STACK_PUSH("Stage::__onResize","flash/display/Stage.hx",870);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Stage::__onMouse","flash/display/Stage.hx",753);
		HX_STACK_THIS(this);
		HX_STACK_ARG(event,"event");
		HX_STACK_ARG(type,"type");
...
{
		HX_STACK_PUSH("Stage::__onKey","flash/display/Stage.hx",704);
		HX_STACK_THIS(this);
		HX_STACK_ARG(event,"event");
		HX_STACK_ARG(type,"type");
		HX_STACK_LINE(706)
...
{
		HX_STACK_PUSH("Stage::__onJoystick","flash/display/Stage.hx",593);
		HX_STACK_THIS(this);
		HX_STACK_ARG(event,"event");
		HX_STACK_ARG(type,"type");
		HX_STACK_LINE(595)
...
{
		HX_STACK_PUSH("Stage::__onFocus","flash/display/Stage.hx",561);
		HX_STACK_THIS(this);
		HX_STACK_ARG(event,"event");
		HX_STACK_LINE(563)
		Array< ::Dynamic > stack = Array_obj< ::Dynamic >::__new();		HX_STACK_VAR(stack,"stack");
...
{
		HX_STACK_PUSH("Stage::__onChange","flash/display/Stage.hx",548);
		HX_STACK_THIS(this);
		HX_STACK_ARG(event,"event");
		HX_STACK_LINE(550)
		::flash::display::DisplayObject object = this->__findByID(event->__Field(HX_CSTRING("id"),true));		HX_STACK_VAR(object,"object");
...
Float Stage_obj::__nextFrameDue( Float otherTimers){
	HX_STACK_PUSH("Stage::__nextFrameDue","flash/display/Stage.hx",524);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Stage::__drag","flash/display/Stage.hx",482);
		HX_STACK_THIS(this);
...
Dynamic Stage_obj::__processStageEvent( Dynamic event){
	HX_STACK_PUSH("Stage::__processStageEvent","flash/display/Stage.hx",474);
	HX_STACK_THIS(this);
	HX_STACK_ARG(event,"event");
	HX_STACK_LINE(476)
...
Float Stage_obj::__doProcessStageEvent( Dynamic event){
	HX_STACK_PUSH("Stage::__doProcessStageEvent","flash/display/Stage.hx",313);
	HX_STACK_THIS(this);
	HX_STACK_ARG(event,"event");
	HX_STACK_LINE(315)
	...
	try{
	...
	catch(Dynamic __e){
		{
			...
			Dynamic error = __e;{
				HX_STACK_LINE(463)
				::flash::Lib_obj::get_current()->loaderInfo->uncaughtErrorEvents->dispatchEvent(::flash::events::UncaughtErrorEvent_obj::__new(::flash::events::UncaughtErrorEvent_obj::UNCAUGHT_ERROR,true,true,error));
			}
		}
	}
	HX_STACK_LINE(468)
...
{
		HX_STACK_PUSH("Stage::__checkRender","flash/display/Stage.hx",266);
		HX_STACK_THIS(this);
		HX_STACK_LINE(266)
		if (((this->frameRate > (int)0))){
			HX_STACK_LINE(270)
...
bool Stage_obj::__checkInOuts( ::flash::events::MouseEvent event,Array< ::Dynamic > stack,::flash::display::TouchInfo touchInfo){
	HX_STACK_PUSH("Stage::__checkInOuts","flash/display/Stage.hx",196);
	HX_STACK_THIS(this);
	HX_STACK_ARG(event,"event");
...
{
		HX_STACK_PUSH("Stage::__checkFocusInOuts","flash/display/Stage.hx",164);
		HX_STACK_THIS(this);
		HX_STACK_ARG(event,"event");
		HX_STACK_ARG(stack,"stack");
		HX_STACK_LINE(166)
...
{
		HX_STACK_PUSH("Stage::showCursor","flash/display/Stage.hx",157);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Stage::resize","flash/display/Stage.hx",135);
		HX_STACK_THIS(this);
		HX_STACK_ARG(width,"width");
		HX_STACK_ARG(height,"height");
		HX_STACK_LINE(135)
...
{
		HX_STACK_PUSH("Stage::invalidate","flash/display/Stage.hx",128);
		HX_STACK_THIS(this);
		HX_STACK_LINE(128)
		this->__invalid = true;
	}
...
int run(){
	HX_STACK_PUSH("Stage::getOrientation","flash/display/Stage.hx",114);
	HX_STACK_LINE(114)
...
int run(){
	HX_STACK_PUSH("Stage::getNormalOrientation","flash/display/Stage.hx",121);
	HX_STACK_LINE(121)
...
{
		HX_STACK_PUSH("Stage::setFixedOrientation","flash/display/Stage.hx",142);
...
bool run(int orientation){
	HX_STACK_PUSH("Stage::shouldRotateInterface","flash/display/Stage.hx",150);
	HX_STACK_ARG(orientation,"orientation");
	HX_STACK_LINE(150)
