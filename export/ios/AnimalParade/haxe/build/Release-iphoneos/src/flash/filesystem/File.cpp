...
::String File_obj::set_url( ::String value){
	...
	if (((value == null()))){
		...
		HX_STACK_LINE(71)
		if ((::StringTools_obj::startsWith(value,::flash::filesystem::File_obj::nme_get_resource_path()))){
			HX_STACK_LINE(71)
...
::flash::filesystem::File File_obj::get_applicationDirectory( ){
	...
	HX_STACK_LINE(45)
	return ::flash::filesystem::File_obj::__new(::flash::filesystem::File_obj::nme_filesystem_get_special_dir((int)0));
}
...
::flash::filesystem::File File_obj::get_applicationStorageDirectory( ){
	...
	HX_STACK_LINE(46)
	return ::flash::filesystem::File_obj::__new(::flash::filesystem::File_obj::nme_filesystem_get_special_dir((int)1));
}
...
::flash::filesystem::File File_obj::get_desktopDirectory( ){
	...
	HX_STACK_LINE(47)
	return ::flash::filesystem::File_obj::__new(::flash::filesystem::File_obj::nme_filesystem_get_special_dir((int)2));
}
...
::flash::filesystem::File File_obj::get_documentsDirectory( ){
	...
	HX_STACK_LINE(48)
	return ::flash::filesystem::File_obj::__new(::flash::filesystem::File_obj::nme_filesystem_get_special_dir((int)3));
}
...
::flash::filesystem::File File_obj::get_userDirectory( ){
	...
	HX_STACK_LINE(49)
	return ::flash::filesystem::File_obj::__new(::flash::filesystem::File_obj::nme_filesystem_get_special_dir((int)4));
}


STATIC_HX_DEFINE_DYNAMIC_FUNC0(File_obj,get_userDirectory,return )

Dynamic File_obj::nme_get_resource_path;
...
Dynamic File_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	case 20:
		...
		break;
	case 21:
		if (HX_FIELD_EQ(inName,"nme_get_resource_path") ) { return nme_get_resource_path; }
		break;
	case 22:
...
Dynamic File_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 20:
		...
		break;
	case 21:
		if (HX_FIELD_EQ(inName,"nme_get_resource_path") ) { nme_get_resource_path=inValue.Cast< Dynamic >(); return inValue; }
		break;
	case 27:
...
static ::String sStaticFields[] = {
	...
	HX_CSTRING("nme_get_resource_path"),
...
static void sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(File_obj::nme_get_resource_path,"nme_get_resource_path");
...
static void sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(File_obj::nme_get_resource_path,"nme_get_resource_path");
...
{
	nme_get_resource_path= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_get_resource_path"),(int)0);
	nme_filesystem_get_special_dir= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_filesystem_get_special_dir"),(int)1);
}
