...
{
HX_STACK_PUSH("FlxGamepadButton::new","flixel/system/input/gamepad/FlxGamepadButton.hx",10);
...
{
		HX_STACK_PUSH("FlxGamepadButton::reset","flixel/system/input/gamepad/FlxGamepadButton.hx",17);
		HX_STACK_THIS(this);
		HX_STACK_LINE(18)
		this->current = (int)0;
		HX_STACK_LINE(19)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("flixel.system.input.gamepad.FlxGamepadButton"), hx::TCanCast< FlxGamepadButton_obj> ,sStaticFields,sMemberFields,
