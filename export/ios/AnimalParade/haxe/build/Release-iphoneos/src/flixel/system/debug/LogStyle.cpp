...
{
HX_STACK_PUSH("LogStyle::new","flixel/system/debug/LogStyle.hx",75);
...
void LogStyle_obj::__boot()
{
	...
	WARNING= ::flixel::system::debug::LogStyle_obj::__new(HX_CSTRING("[WARNING] "),HX_CSTRING("FFFF00"),(int)12,true,false,false,HX_CSTRING("flixel/snd/beep.wav"),true,null());
	ERROR= ::flixel::system::debug::LogStyle_obj::__new(HX_CSTRING("[ERROR] "),HX_CSTRING("FF0000"),(int)12,true,false,false,HX_CSTRING("flixel/snd/beep.wav"),true,null());
