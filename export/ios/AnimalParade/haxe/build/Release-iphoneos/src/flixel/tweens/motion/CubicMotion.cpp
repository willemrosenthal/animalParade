...
{
HX_STACK_PUSH("CubicMotion::new","flixel/tweens/motion/CubicMotion.hx",17);
...
{
		HX_STACK_PUSH("CubicMotion::update","flixel/tweens/motion/CubicMotion.hx",54);
		HX_STACK_THIS(this);
		HX_STACK_LINE(55)
		this->super::update();
		HX_STACK_LINE(56)
		this->x = ((((((this->_t * this->_t) * this->_t) * (((this->_toX + ((int)3 * ((this->_aX - this->_bX)))) - this->_fromX))) + ((((int)3 * this->_t) * this->_t) * (((this->_fromX - ((int)2 * this->_aX)) + this->_bX)))) + (((int)3 * this->_t) * ((this->_aX - this->_fromX)))) + this->_fromX);
		HX_STACK_LINE(57)
		this->y = ((((((this->_t * this->_t) * this->_t) * (((this->_toY + ((int)3 * ((this->_aY - this->_bY)))) - this->_fromY))) + ((((int)3 * this->_t) * this->_t) * (((this->_fromY - ((int)2 * this->_aY)) + this->_bY)))) + (((int)3 * this->_t) * ((this->_aY - this->_fromY)))) + this->_fromY);
		HX_STACK_LINE(58)
		if ((this->finished)){
			HX_STACK_LINE(59)
			this->postUpdate();
...
::flixel::tweens::motion::CubicMotion CubicMotion_obj::setMotion( Float fromX,Float fromY,Float aX,Float aY,Float bX,Float bY,Float toX,Float toY,Float duration,Dynamic ease){
	HX_STACK_PUSH("CubicMotion::setMotion","flixel/tweens/motion/CubicMotion.hx",37);
	HX_STACK_THIS(this);
