...
{
HX_STACK_PUSH("Fader::new","flixel/tweens/sound/Fader.hx",18);
...
{
		HX_STACK_PUSH("Fader::update","flixel/tweens/sound/Fader.hx",40);
		HX_STACK_THIS(this);
		HX_STACK_LINE(41)
		this->super::update();
		HX_STACK_LINE(42)
		::flixel::FlxG_obj::sound->set_volume((this->_start + (this->_range * this->_t)));
	}
return null();
}
...
{
		HX_STACK_PUSH("Fader::fadeTo","flixel/tweens/sound/Fader.hx",29);
		HX_STACK_THIS(this);
