...
{
		HX_STACK_PUSH("TimerManager::onStateSwitch","flixel/plugin/TimerManager.hx",108);
		HX_STACK_THIS(this);
		HX_STACK_LINE(108)
		this->clear();
	}
...
{
		HX_STACK_PUSH("TimerManager::clear","flixel/plugin/TimerManager.hx",99);
		HX_STACK_THIS(this);
		HX_STACK_LINE(99)
...
bool ReturnInPool = __o_ReturnInPool.Default(true);
	HX_STACK_PUSH("TimerManager::remove","flixel/plugin/TimerManager.hx",80);
	HX_STACK_THIS(this);
	...
	HX_STACK_ARG(ReturnInPool,"ReturnInPool");
{
		...
		HX_STACK_LINE(86)
		int index = ::flixel::util::FlxArrayUtil_obj::indexOf_flixel_util_FlxTimer(this->_timers,Timer,null());		HX_STACK_VAR(index,"index");
		HX_STACK_LINE(87)
		if (((index >= (int)0))){
			HX_STACK_LINE(90)
			this->_timers[index] = this->_timers->__get((this->_timers->length - (int)1)).StaticCast< ::flixel::util::FlxTimer >();
			HX_STACK_LINE(91)
			this->_timers->pop().StaticCast< ::flixel::util::FlxTimer >();
		}
	}
return null();
}
...
{
		HX_STACK_PUSH("TimerManager::add","flixel/plugin/TimerManager.hx",65);
		HX_STACK_THIS(this);
		HX_STACK_ARG(Timer,"Timer");
		HX_STACK_LINE(65)
