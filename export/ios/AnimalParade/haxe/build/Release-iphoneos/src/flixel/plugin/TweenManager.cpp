...
{
		HX_STACK_PUSH("TweenManager::onStateSwitch","flixel/plugin/TweenManager.hx",123);
		HX_STACK_THIS(this);
		HX_STACK_LINE(123)
		this->clear(true);
	}
...
bool Destroy = __o_Destroy.Default(false);
	HX_STACK_PUSH("TweenManager::clear","flixel/plugin/TweenManager.hx",114);
	HX_STACK_THIS(this);
	...
	HX_STACK_ARG(Destroy,"Destroy");
{
		...
		Tween->active = false;
		HX_STACK_LINE(103)
		this->list[::flixel::util::FlxArrayUtil_obj::indexOf_flixel_tweens_FlxTween(this->list,Tween,null())] = this->list->__get((this->list->length - (int)1)).StaticCast< ::flixel::tweens::FlxTween >();
		HX_STACK_LINE(104)
		this->list->pop().StaticCast< ::flixel::tweens::FlxTween >();
		HX_STACK_LINE(106)
		return Tween;
	}
}
