...
{
		HX_STACK_PUSH("FlxSystemButton::destroy","flixel/system/ui/FlxSystemButton.hx",114);
		HX_STACK_THIS(this);
		HX_STACK_LINE(115)
...
{
		HX_STACK_PUSH("FlxSystemButton::onMouseOut","flixel/system/ui/FlxSystemButton.hx",109);
		HX_STACK_THIS(this);
		HX_STACK_ARG(E,"E");
		HX_STACK_LINE(110)
...
{
		HX_STACK_PUSH("FlxSystemButton::onMouseOver","flixel/system/ui/FlxSystemButton.hx",104);
		HX_STACK_THIS(this);
		HX_STACK_ARG(E,"E");
		HX_STACK_LINE(105)
		::flixel::system::ui::FlxSystemButton _g = hx::ObjectPtr<OBJ_>(this);		HX_STACK_VAR(_g,"_g");
...
{
		HX_STACK_PUSH("FlxSystemButton::onMouseUp","flixel/system/ui/FlxSystemButton.hx",95);
		HX_STACK_THIS(this);
		HX_STACK_ARG(E,"E");
		HX_STACK_LINE(95)
...
{
		HX_STACK_PUSH("FlxSystemButton::changeIcon","flixel/system/ui/FlxSystemButton.hx",84);
		HX_STACK_THIS(this);
