...
{
HX_STACK_PUSH("Motion::new","flixel/tweens/motion/Motion.hx",15);
...
{
		HX_STACK_PUSH("Motion::postUpdate","flixel/tweens/motion/Motion.hx",60);
		HX_STACK_THIS(this);
		HX_STACK_LINE(60)
		if (((this->_object != null()))){
			HX_STACK_LINE(62)
			this->_object->__Field(HX_CSTRING("setPosition"),true)(this->x,this->y);
		}
	}
return null();
}
...
{
		HX_STACK_PUSH("Motion::update","flixel/tweens/motion/Motion.hx",54);
		HX_STACK_THIS(this);
		HX_STACK_LINE(55)
		this->super::update();
		HX_STACK_LINE(56)
...
Dynamic Motion_obj::setObject( Dynamic object){
	HX_STACK_PUSH("Motion::setObject","flixel/tweens/motion/Motion.hx",47);
	HX_STACK_THIS(this);
	HX_STACK_ARG(object,"object");
	HX_STACK_LINE(48)
	this->_object = object;
	HX_STACK_LINE(49)
	this->_object->__Field(HX_CSTRING("set_immovable"),true)(true);
	HX_STACK_LINE(50)
...
{
		HX_STACK_PUSH("Motion::destroy","flixel/tweens/motion/Motion.hx",41);
		HX_STACK_THIS(this);
		HX_STACK_LINE(42)
		this->super::destroy();
		HX_STACK_LINE(43)
