...
::flash::display::BitmapData TileSheetExt_obj::get_nmeBitmap( ){
	HX_STACK_PUSH("TileSheetExt::get_nmeBitmap","flixel/system/layer/TileSheetExt.hx",110);
	HX_STACK_THIS(this);
	HX_STACK_LINE(110)
...
{
		HX_STACK_PUSH("TileSheetExt::destroy","flixel/system/layer/TileSheetExt.hx",89);
		HX_STACK_THIS(this);
		HX_STACK_LINE(91)
		this->__bitmap = null();
		HX_STACK_LINE(92)
		...
		if (((this->tileIDs != null()))){
			struct _Function_2_1{
				inline static Dynamic Block( ::flixel::system::layer::TileSheetExt_obj *__this){
					HX_STACK_PUSH("*::closure","flixel/system/layer/TileSheetExt.hx",98);
					{
						HX_STACK_LINE(98)
						...
						Dynamic run(){
							HX_STACK_PUSH("*::_Function_3_1","flixel/system/layer/TileSheetExt.hx",98);
							{
								HX_STACK_LINE(98)
...
int TileSheetExt_obj::addTileRectID( ::flash::geom::Rectangle rect,::flash::geom::Point point){
	HX_STACK_PUSH("TileSheetExt::addTileRectID","flixel/system/layer/TileSheetExt.hx",72);
	HX_STACK_THIS(this);
