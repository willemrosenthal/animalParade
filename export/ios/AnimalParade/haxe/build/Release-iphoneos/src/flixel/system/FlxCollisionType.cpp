...
::flixel::system::FlxCollisionType FlxCollisionType_obj::_NULL;
...
int FlxCollisionType_obj::__FindIndex(::String inName)
{
	...
	if (inName==HX_CSTRING("NULL")) return 0;
...
Dynamic FlxCollisionType_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	if (inName==HX_CSTRING("NULL")) return _NULL;
...
static void sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(FlxCollisionType_obj::_NULL,"_NULL");
...
static void sVisitStatic(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(FlxCollisionType_obj::_NULL,"_NULL");
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("flixel.system.FlxCollisionType"), hx::TCanCast< FlxCollisionType_obj >,sStaticFields,sMemberFields,
	...
	&super::__SGetClass(), &CreateFlxCollisionType_obj, sMarkStatics, sVisitStatic);
}

void FlxCollisionType_obj::__boot()
{
hx::Static(GROUP) = hx::CreateEnum< FlxCollisionType_obj >(HX_CSTRING("GROUP"),2);
hx::Static(_NULL) = hx::CreateEnum< FlxCollisionType_obj >(HX_CSTRING("NULL"),0);
