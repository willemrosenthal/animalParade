...
{
HX_STACK_PUSH("QuadMotion::new","flixel/tweens/motion/QuadMotion.hx",22);
...
Float QuadMotion_obj::get_distance( ){
	HX_STACK_PUSH("QuadMotion::get_distance","flixel/tweens/motion/QuadMotion.hx",83);
	HX_STACK_THIS(this);
	HX_STACK_LINE(84)
...
{
		HX_STACK_PUSH("QuadMotion::update","flixel/tweens/motion/QuadMotion.hx",68);
		HX_STACK_THIS(this);
		HX_STACK_LINE(69)
		this->super::update();
		HX_STACK_LINE(70)
		this->x = ((((this->_fromX * (((int)1 - this->_t))) * (((int)1 - this->_t))) + (((this->_controlX * (int)2) * (((int)1 - this->_t))) * this->_t)) + ((this->_toX * this->_t) * this->_t));
		HX_STACK_LINE(71)
		this->y = ((((this->_fromY * (((int)1 - this->_t))) * (((int)1 - this->_t))) + (((this->_controlY * (int)2) * (((int)1 - this->_t))) * this->_t)) + ((this->_toY * this->_t) * this->_t));
		HX_STACK_LINE(72)
		if ((this->finished)){
			HX_STACK_LINE(73)
			this->postUpdate();
...
bool UseDuration = __o_UseDuration.Default(true);
	HX_STACK_PUSH("QuadMotion::setMotion","flixel/tweens/motion/QuadMotion.hx",42);
	HX_STACK_THIS(this);
