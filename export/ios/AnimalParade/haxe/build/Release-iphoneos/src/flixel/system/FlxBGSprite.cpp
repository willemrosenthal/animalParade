...
{
HX_STACK_PUSH("FlxBGSprite::new","flixel/system/FlxBGSprite.hx",18);
{
	HX_STACK_LINE(19)
...
{
		HX_STACK_PUSH("FlxBGSprite::draw","flixel/system/FlxBGSprite.hx",28);
		HX_STACK_THIS(this);
		HX_STACK_LINE(29)
...
void FlxBGSprite_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(FlxBGSprite);
	super::__Mark(HX_MARK_ARG);
	HX_MARK_END_CLASS();
}

void FlxBGSprite_obj::__Visit(HX_VISIT_PARAMS)
{
