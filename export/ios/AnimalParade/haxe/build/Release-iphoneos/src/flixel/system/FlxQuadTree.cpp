...
bool FlxQuadTree_obj::overlapNode( ){
	...
	while(((::flixel::system::FlxQuadTree_obj::_iterator != null()))){
		...
		HX_STACK_LINE(679)
		::flixel::system::FlxQuadTree_obj::_objectHullWidth = (::flixel::system::FlxQuadTree_obj::_object->width + ((  (((::flixel::system::FlxQuadTree_obj::_objectHullWidth > (int)0))) ? Float(::flixel::system::FlxQuadTree_obj::_objectHullWidth) : Float(-(::flixel::system::FlxQuadTree_obj::_objectHullWidth)) )));
		HX_STACK_LINE(680)
		...
		HX_STACK_LINE(681)
		::flixel::system::FlxQuadTree_obj::_objectHullHeight = (::flixel::system::FlxQuadTree_obj::_object->height + ((  (((::flixel::system::FlxQuadTree_obj::_objectHullHeight > (int)0))) ? Float(::flixel::system::FlxQuadTree_obj::_objectHullHeight) : Float(-(::flixel::system::FlxQuadTree_obj::_objectHullHeight)) )));
		HX_STACK_LINE(684)
		...
		HX_STACK_LINE(687)
		::flixel::system::FlxQuadTree_obj::_checkObjectHullWidth = (checkObject->width + ((  (((::flixel::system::FlxQuadTree_obj::_checkObjectHullWidth > (int)0))) ? Float(::flixel::system::FlxQuadTree_obj::_checkObjectHullWidth) : Float(-(::flixel::system::FlxQuadTree_obj::_checkObjectHullWidth)) )));
		HX_STACK_LINE(688)
		::flixel::system::FlxQuadTree_obj::_checkObjectHullHeight = (checkObject->y - checkObject->last->y);
		HX_STACK_LINE(689)
		::flixel::system::FlxQuadTree_obj::_checkObjectHullHeight = (checkObject->height + ((  (((::flixel::system::FlxQuadTree_obj::_checkObjectHullHeight > (int)0))) ? Float(::flixel::system::FlxQuadTree_obj::_checkObjectHullHeight) : Float(-(::flixel::system::FlxQuadTree_obj::_checkObjectHullHeight)) )));
		HX_STACK_LINE(692)
					...
					if (((collisionType == ::flixel::system::FlxCollisionType_obj::GROUP))){
						...
						if (((bool((collisionType == ::flixel::system::FlxCollisionType_obj::OBJECT)) || bool((collisionType == ::flixel::system::FlxCollisionType_obj::TILEMAP))))){
							...
							if (((bool(::flixel::system::FlxQuadTree_obj::_object->exists) && bool((::flixel::system::FlxQuadTree_obj::_object->allowCollisions != (int)0))))){
								...
								HX_STACK_LINE(435)
								::flixel::system::FlxQuadTree_obj::_objectRightEdge = (::flixel::system::FlxQuadTree_obj::_object->x + ::flixel::system::FlxQuadTree_obj::_object->width);
								HX_STACK_LINE(436)
								::flixel::system::FlxQuadTree_obj::_objectBottomEdge = (::flixel::system::FlxQuadTree_obj::_object->y + ::flixel::system::FlxQuadTree_obj::_object->height);
								HX_STACK_LINE(437)
								this->addObject();
							}
						}
