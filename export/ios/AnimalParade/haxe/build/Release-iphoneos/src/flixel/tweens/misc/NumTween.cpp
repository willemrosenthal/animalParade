...
{
HX_STACK_PUSH("NumTween::new","flixel/tweens/misc/NumTween.hx",22);
...
{
		HX_STACK_PUSH("NumTween::update","flixel/tweens/misc/NumTween.hx",46);
		HX_STACK_THIS(this);
		HX_STACK_LINE(47)
		this->super::update();
		HX_STACK_LINE(48)
...
::flixel::tweens::misc::NumTween NumTween_obj::tween( Float fromValue,Float toValue,Float duration,Dynamic ease){
	HX_STACK_PUSH("NumTween::tween","flixel/tweens/misc/NumTween.hx",35);
	HX_STACK_THIS(this);
