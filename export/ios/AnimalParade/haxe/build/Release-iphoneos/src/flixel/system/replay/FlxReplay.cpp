...
{
		HX_STACK_PUSH("FlxReplay::rewind","flixel/system/replay/FlxReplay.hx",235);
		HX_STACK_THIS(this);
		HX_STACK_LINE(236)
		this->_marker = (int)0;
		HX_STACK_LINE(237)
...
{
		HX_STACK_PUSH("FlxReplay::playNextFrame","flixel/system/replay/FlxReplay.hx",201);
		HX_STACK_THIS(this);
		HX_STACK_LINE(202)
		{
			HX_STACK_LINE(202)
		...
		if (((fr->keys != null()))){
			HX_STACK_LINE(218)
			::flixel::FlxG_obj::keyboard->playback(fr->keys);
		}
		HX_STACK_LINE(224)
		if (((fr->mouse != null()))){
			HX_STACK_LINE(225)
...
{
		HX_STACK_PUSH("FlxReplay::recordFrame","flixel/system/replay/FlxReplay.hx",161);
		HX_STACK_THIS(this);
		HX_STACK_LINE(162)
		bool continueFrame = true;		HX_STACK_VAR(continueFrame,"continueFrame");
		HX_STACK_LINE(165)
		Array< ::Dynamic > keysRecord = ::flixel::FlxG_obj::keyboard->record();		HX_STACK_VAR(keysRecord,"keysRecord");
		HX_STACK_LINE(166)
		if (((keysRecord == null()))){
			HX_STACK_LINE(166)
			continueFrame = false;
...
::String FlxReplay_obj::save( ){
	HX_STACK_PUSH("FlxReplay::save","flixel/system/replay/FlxReplay.hx",143);
	HX_STACK_THIS(this);
	HX_STACK_LINE(144)
...
{
		HX_STACK_PUSH("FlxReplay::init","flixel/system/replay/FlxReplay.hx",130);
		HX_STACK_THIS(this);
		HX_STACK_LINE(131)
