	...
	if (((bitmapDataCache != null()))){
		struct _Function_2_1{
			inline static Dynamic Block( ::haxe::ds::StringMap &bitmapDataCache){
				HX_STACK_PUSH("*::closure","flixel/system/frontEnds/BitmapFrontEnd.hx",432);
				{
					HX_STACK_LINE(432)
					...
					Dynamic run(){
						HX_STACK_PUSH("*::_Function_3_1","flixel/system/frontEnds/BitmapFrontEnd.hx",432);
						{
							HX_STACK_LINE(432)
		...
		if (((this->_cache != null()))){
			...
			for(::cpp::FastIterator_obj< ::String > *__it = ::cpp::CreateFastIterator< ::String >(this->_cache->keys());  __it->hasNext(); ){
				::String key = __it->next();
				{
					...
					obj = this->_cache->get(key);
					HX_STACK_LINE(73)
					if (((bool((obj != null())) && bool(obj->get_canBeDumped())))){
						HX_STACK_LINE(74)
						obj->dump();
					}
				}
...
::flixel::util::loaders::CachedGraphics BitmapFrontEnd_obj::get_whitePixel( ){
	...
	if (((this->_whitePixel == null()))){
		...
		HX_STACK_LINE(35)
		this->_whitePixel->get_tilesheet()->addTileRect(::flash::geom::Rectangle_obj::__new((int)0,(int)0,(int)1,(int)1),::flash::geom::Point_obj::__new((int)0,(int)0));
	}
	HX_STACK_LINE(38)
