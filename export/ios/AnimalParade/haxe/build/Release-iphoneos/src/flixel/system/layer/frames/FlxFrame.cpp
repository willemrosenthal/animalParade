...
{
		HX_STACK_PUSH("FlxFrame::destroyBitmapDatas","flixel/system/layer/frames/FlxFrame.hx",146);
		HX_STACK_THIS(this);
		HX_STACK_LINE(147)
...
::flash::display::BitmapData FlxFrame_obj::getHVReversedBitmap( ){
	HX_STACK_PUSH("FlxFrame::getHVReversedBitmap","flixel/system/layer/frames/FlxFrame.hx",129);
	HX_STACK_THIS(this);
	HX_STACK_LINE(130)
	if (((this->_hvReversedBitmapData != null()))){
		HX_STACK_LINE(131)
...
::flash::display::BitmapData FlxFrame_obj::getVReversedBitmap( ){
	HX_STACK_PUSH("FlxFrame::getVReversedBitmap","flixel/system/layer/frames/FlxFrame.hx",112);
	HX_STACK_THIS(this);
	HX_STACK_LINE(113)
	if (((this->_vReversedBitmapData != null()))){
		HX_STACK_LINE(114)
...
::flash::display::BitmapData FlxFrame_obj::getHReversedBitmap( ){
	HX_STACK_PUSH("FlxFrame::getHReversedBitmap","flixel/system/layer/frames/FlxFrame.hx",95);
	HX_STACK_THIS(this);
	HX_STACK_LINE(96)
	if (((this->_hReversedBitmapData != null()))){
		HX_STACK_LINE(97)
...
::flash::display::BitmapData FlxFrame_obj::getBitmap( ){
	HX_STACK_PUSH("FlxFrame::getBitmap","flixel/system/layer/frames/FlxFrame.hx",62);
	HX_STACK_THIS(this);
	HX_STACK_LINE(63)
	if (((this->_bitmapData != null()))){
		HX_STACK_LINE(64)
...
{
		HX_STACK_PUSH("FlxFrame::destroy","flixel/system/layer/frames/FlxFrame.hx",48);
		HX_STACK_THIS(this);
		HX_STACK_LINE(49)
		this->name = null();
		HX_STACK_LINE(50)
