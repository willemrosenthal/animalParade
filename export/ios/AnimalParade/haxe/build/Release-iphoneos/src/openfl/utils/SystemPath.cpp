...
::String SystemPath_obj::get_applicationDirectory( ){
	...
	HX_STACK_LINE(31)
	return ::openfl::utils::SystemPath_obj::nme_filesystem_get_special_dir((int)0);
}
...
::String SystemPath_obj::get_applicationStorageDirectory( ){
	...
	HX_STACK_LINE(32)
	return ::openfl::utils::SystemPath_obj::nme_filesystem_get_special_dir((int)1);
}
...
::String SystemPath_obj::get_desktopDirectory( ){
	...
	HX_STACK_LINE(33)
	return ::openfl::utils::SystemPath_obj::nme_filesystem_get_special_dir((int)2);
}
...
::String SystemPath_obj::get_documentsDirectory( ){
	...
	HX_STACK_LINE(34)
	return ::openfl::utils::SystemPath_obj::nme_filesystem_get_special_dir((int)3);
}
...
::String SystemPath_obj::get_userDirectory( ){
	...
	HX_STACK_LINE(35)
	return ::openfl::utils::SystemPath_obj::nme_filesystem_get_special_dir((int)4);
}


STATIC_HX_DEFINE_DYNAMIC_FUNC0(SystemPath_obj,get_userDirectory,return )

Dynamic SystemPath_obj::nme_filesystem_get_special_dir;
...
static void sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(SystemPath_obj::nme_filesystem_get_special_dir,"nme_filesystem_get_special_dir");
};
...
static void sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(SystemPath_obj::nme_filesystem_get_special_dir,"nme_filesystem_get_special_dir");
};
