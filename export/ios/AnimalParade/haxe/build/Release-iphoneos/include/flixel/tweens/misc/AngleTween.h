...
class HXCPP_CLASS_ATTRIBUTES  AngleTween_obj : public ::flixel::tweens::FlxTween_obj{
	...
	public:
		static hx::ObjectPtr< AngleTween_obj > __new(Dynamic complete,hx::Null< int >  __o_type);
		...
		virtual ::flixel::tweens::misc::AngleTween tween( Float fromAngle,Float toAngle,Float duration,Dynamic ease);
		Dynamic tween_dyn();
