...
class HXCPP_CLASS_ATTRIBUTES  FlxColorUtil_obj : public hx::Object{
	...
	public:
		...
		static ::String RGBAtoHexString( int Color);
		static Dynamic RGBAtoHexString_dyn();

		static ::String RGBAtoWebString( int Color);
		static Dynamic RGBAtoWebString_dyn();

		static ::String colorToHexString( int Color);
		static Dynamic colorToHexString_dyn();

		static int HSVtoRGBA( Float H,Float S,Float V,hx::Null< int >  Alpha);
		static Dynamic HSVtoRGBA_dyn();

		static Dynamic RGBtoHSV( int Color);
		static Dynamic RGBtoHSV_dyn();

		static int RGBAtoRGB( int Color);
		static Dynamic RGBAtoRGB_dyn();
