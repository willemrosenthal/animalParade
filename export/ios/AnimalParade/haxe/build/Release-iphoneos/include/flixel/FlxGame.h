...
class HXCPP_CLASS_ATTRIBUTES  FlxGame_obj : public ::flash::display::Sprite_obj{
	public:
		...
		FlxGame_obj();
		Void __construct(int GameSizeX,int GameSizeY,::Class InitialState,hx::Null< Float >  __o_Zoom,hx::Null< int >  __o_GameFramerate,hx::Null< int >  __o_FlashFramerate,hx::Null< bool >  __o_SkipSplash);

	public:
		static hx::ObjectPtr< FlxGame_obj > __new(int GameSizeX,int GameSizeY,::Class InitialState,hx::Null< Float >  __o_Zoom,hx::Null< int >  __o_GameFramerate,hx::Null< int >  __o_FlashFramerate,hx::Null< bool >  __o_SkipSplash);
		...
		virtual Void requestNewState( ::flixel::FlxState newState);
