...
class HXCPP_CLASS_ATTRIBUTES  DebuggerFrontEnd_obj : public hx::Object{
	...
	public:
		...
		virtual ::flixel::system::ui::FlxSystemButton addButton( ::flixel::system::debug::ButtonAlignment Alignment,::String IconPath,Dynamic DownHandler,hx::Null< bool >  ToggleMode,hx::Null< bool >  UpdateLayout);
