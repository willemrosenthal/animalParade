...
class HXCPP_CLASS_ATTRIBUTES  FlxSystemButton_obj : public ::flash::display::Sprite_obj{
	public:
		...
		FlxSystemButton_obj();
		Void __construct(::String IconPath,Dynamic DownHandler,hx::Null< bool >  __o_ToggleMode);

	public:
		static hx::ObjectPtr< FlxSystemButton_obj > __new(::String IconPath,Dynamic DownHandler,hx::Null< bool >  __o_ToggleMode);
		...
		virtual Void changeIcon( ::String IconPath);
