...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "AnimalParade", "com.example.myapp", "0.0.1");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "AnimalParade", null, { width: 640, height: 1136 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 640, height: 1136 });
			#end
